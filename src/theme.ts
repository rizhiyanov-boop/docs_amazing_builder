...
const THEMES: Record<ThemeName, ThemeTokens> = {
  ...
  light: {
    ...
    text: '#0f172a',
    muted: '#6a6a63',
    accent: 'linear-gradient(135deg, #171717, #3b3b3b)',
    accentSolid: '#171717',
    border: '#dfd9cc',
    shadow: '0 10px 24px rgba(15, 23, 42, 0.06)',
    inputBg: '#ffffff',
    inputText: '#111111',
    scrollbarTrack: '#f2eee5',
    scrollbarThumb: '#ffffff',
    scrollbarThumbHover: '#ece7dc',
    buttonBg: '#111111',
    buttonText: '#ffffff',
    buttonShadow: '0 8px 18px rgba(17, 17, 17, 0.12)',
    buttonShadowHover: '0 12px 22px rgba(17, 17, 17, 0.16)',
    activeBg: '#111111',
    activeText: '#ffffff',
    previewBg: '#ffffff',
    previewText: '#111827',
    previewBorder: '#dfd9cc',
    previewTableHead: '#f6f3eb'
  }
};
